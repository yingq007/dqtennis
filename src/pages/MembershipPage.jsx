...
const MEMBERSHIPS = membershipData.memberships.map((t) => ({ ...t, ctaHref: MEMBERSHIP_URL }));
const PACKAGES    = membershipData.packages.map((t)    => ({ ...t, ctaHref: MEMBERSHIP_URL }));
const LESSONS     = membershipData.lessons.map((t)     => ({ ...t, ctaHref: BOOKING_URL }));
    ...
    <div className="h-screen overflow-y-scroll snap-y snap-mandatory font-sans text-gray-800">
      ...
      <section className="snap-start min-h-screen flex flex-col justify-center px-6 py-24 bg-clay-light">
        ...
        <p className="text-center text-sm text-gray-500 mt-8">
          Both private and group lessons available for adults &amp; kids.
        </p>
      </section>
